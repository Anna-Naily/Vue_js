...
<div>
    ...
    <input class="checkbox__button" type="checkbox" id="checkbox" @change="setVisible">
    ...
    <div class="keyboard" v-show="keyboardVisible">
        ...
        <div class="radio">
            <input class="radio__button" type="radio" id="operand1" value="1" v-model="operandFlag">
            <label for="operand1">Первое значение</label>
            <input class="radio__button" type="radio" id="operand2" value="2" v-model="operandFlag">
